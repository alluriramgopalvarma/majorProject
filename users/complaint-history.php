                      ...
                      ?>
                        <tr>
                          ...
                          <td align="center"><?php
                                              ...
                                              $query2 = mysqli_query($con, "select eFIR from efir where uID='" . $_SESSION['id'] . "' and complaintID='$cn'");
                                              if (mysqli_num_rows($query2) > 0) {
                                                ...
                                                while ($row1 = mysqli_fetch_assoc($query2)) {
                                                  ...
                                                  <a href="FIR.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>">
                                                  <button type="button" class="btn btn-primary">FIR </button></a>
