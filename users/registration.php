...
if (isset($_POST['data'])) {
	...
	$status = 1;
	$query123 = "insert into users(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')";
	if (mysqli_query($con, $query123)) {
...
<head>
	...
	<title>Virtual Police Station | User Registration</title>
	...
	<div id="login-page">
		<div class="container">
			...
			<form class="form-login" method="post">
				<h2 class="form-login-heading" style="background:#096ebc">User Registration</h2>
				...
				<div class="login-wrap">
					...
					<button class="btn btn-theme btn-block" style="background:black" type="submit" name="data" id="submit"><i class="fa fa-user"></i> Register</button>
					<hr>
